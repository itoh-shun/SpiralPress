...
class Category extends SpiralModel {
    ...
    protected array $fields = [
        'id', 'createAt', 'updateAt'  , 'categoryId', 'categoryName' , 'projectId'
    ];
    ...
    public static function findByCategoryIdAndProjectId($categoryId, $projectId){
        ...
        $instance = new static();
        $data = $instance->getManager()->where('categoryId', $categoryId)->where('projectId',$projectId)->get();
    ...
    public static function allByProjectId($projectId){
        /** @phpstan-ignore-next-line */
        $instance = new static();
        $data = $instance->getManager()->where('projectId',$projectId)->get();
